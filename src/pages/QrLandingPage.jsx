      ...
      <div style={{
        ...
        <motion.a
          ...
          style={{
            width: '100%', maxWidth: 340,
            padding: 1.5,
            background: 'linear-gradient(90deg, rgba(200,215,232,0.55) 0%, rgba(95,135,180,0.85) 25%, rgba(220,230,242,0.75) 50%, rgba(80,118,160,0.85) 75%, rgba(200,215,232,0.55) 100%)',
            backgroundSize: '200% 100%',
            borderRadius: 10,
            textDecoration: 'none',
            cursor: 'pointer',
            WebkitTapHighlightColor: 'transparent',
            boxShadow: '0 6px 28px rgba(20,40,80,0.45), 0 0 18px rgba(140,200,255,0.12)',
          }}>
          <div style={{
            position: 'relative',
            borderRadius: 8.5,
            overflow: 'hidden',
            padding: '16px 18px',
            background: 'linear-gradient(135deg, #1F2630 0%, #131820 55%, #1F2630 100%)',
            display: 'flex', alignItems: 'center', gap: 18,
            textAlign: 'left',
          }}>
            {/* Subtelna srebrno-błękitna poświata w tle (zamiast płomieni) */}
            <div style={{
              position: 'absolute', inset: 0, pointerEvents: 'none',
              background: 'radial-gradient(ellipse 70% 50% at 25% 0%, rgba(180,210,240,0.10) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 100%, rgba(140,180,220,0.08) 0%, transparent 65%)',
            }}/>
            ...
            <div style={{
              ...
              <p style={{
                ...
                margin: 0, lineHeight: 1,
                background: 'linear-gradient(180deg, #F0F8FF 0%, #C8D8E8 60%, #8FA8C0 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
